...
if __name__ == "__main__":
    ...
    list_of_cardHolders.append(
        cardHolder("4532772818527395", 1234, "John", "Griffin", 1050.30)
    )
    list_of_cardHolders.append(
        cardHolder("4532761841325802", 4321, "Emma", "Jones", 500.22)
    )
    list_of_cardHolders.append(
        cardHolder("5128381368581872", 6543, "Flavia", "Jeckson", 150.79)
    )
    list_of_cardHolders.append(
        cardHolder("6011188364697109", 8765, "Kira", "Dopkins", 950.93)
    )
    list_of_cardHolders.append(
        cardHolder("3490693153147110", 2040, "Anna", "Watson", 10.28)
    )
